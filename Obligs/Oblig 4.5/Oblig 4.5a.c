...
/**     Task 39 a) in grprog.pdf - Oblig 4.5
 *
 *      Program description:
 *          - The program is a art gallery management system with a menu-driven interface.
 *          - It uses a struct Maleri to represent paintings and includes functions for adding,
 *            displaying, and filtering paintings based on size and location.
 *          - Dynamic memory allocation is employed for managing the collection of paintings.
 *
 *      @file Oblig 4.5a.c
 *      @date 16-Nov-23
 *
