...
/**     Task 39 b) in grprog.pdf - Oblig 4.5
 *
 *      Program description:
 *          - A task management system with features for creating, viewing, assigning, and removing tasks.
 *          - It employs dynamic memory allocation and includes essential functions like task creation
 *            (nyOppgave) and display (skrivOppgaver)
 *          - The main program uses a menu-driven interface, interacting with tasks and utilizing the
 *            "LesData.h" toolkit for input
 *
 *      @file Oblig 4.5b.c
 *      @date 16-Nov-23
 *
